                          ...
                          <div class="form-group">
                            <div class="col-sm-12">
                              <div class="ckbox ckbox-success">
                                <input type="checkbox" value="true" id="Agree" tabindex="5" name="Agree" data-parsley-required="true"  <?php if($this->Session->read('Application.Agree')=="true"){ echo "checked";} ?>/>
                                <label
	...
	<div class="container">
    	<div class="row">
        	<div class="col-sm-4">
                ...
                <?php echo $this->Html->image('cpk_icon01.jpg', array('alt'=>'Chesapeake Loan Services', 'class'=>'', 'width'=>'150', 'height'=>'154', 'url'=>'')); ?>
                 </div>
        	...
        	<div class="col-sm-4">
            	<div class="ws_sec4_icon">
                <?php echo $this->Html->image('cpk_icon02.jpg', array('alt'=>'Chesapeake Loan Services', 'class'=>'', 'width'=>'150', 'height'=>'154', 'url'=>'/')); ?>
                </div>
                <div class="ws_sec4_icontxt">
        	...
        	<div class="col-sm-4">
            	<div class="ws_sec4_icon">
                <?php echo $this->Html->image('cpk_icon03.jpg', array('alt'=>'Chesapeake Loan Services', 'class'=>'', 'width'=>'149', 'height'=>'154', 'url'=>'/')); ?> </div>
                <div class="ws_sec4_icontxt">
