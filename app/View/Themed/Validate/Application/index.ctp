	              ...
	              <div class="tab-content <?php echo $this->Session->read('Application.AppType');?>">
	                  ...
	                  <div class="tab-pane tab2" id="tab2">
	                    ...
	                    <div class="row">
	                    	...
	                    	<div class="col-sm-4">
                    		<label for="ValidateEmail">Validation Code <a href="https://global.leadstudio.com/validation" data-title="Validation Code" data-toggle="lightbox" data-gallery="remoteload">(what is this?)</a></label>
                    		<input data-parsley-group="step2" name="ValidateEmail" id="ValidateEmail" type="text" class="form-control" tabindex="8" size="20" placeholder="Validation Code" required>
                    	</div>
	                    </div>
					</div><!-- tab-pane -->
