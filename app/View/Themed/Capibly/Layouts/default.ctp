		...
		<div id="ws_pghd_wrap">
			<div class="container">
		    	<div class="row">
		        	<div class="col-sm-12">
		            	<div id="ws_logo">
		            	<?php echo $this->Html->image('capibly.png', array('alt'=>'Capibly', 'class'=>'img-responsive', 'width'=>'223', 'height'=>'79', 'url'=>'/')); ?>
		                </div>
		                <div id="ws_tag">
