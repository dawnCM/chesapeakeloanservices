	                  ...
	                  <div class="tab-pane tab1" id="tab1">
	                    ...
	                    <div class="row">
							...
							<label for="ResidentSinceDate">Months at Residence</label>
								...
								<select name="ResidentSinceDate" class="form-control" id="ResidentSinceDate" tabindex="11" 
								data-parsley-required="true" 
								data-parsley-group="step1">
									
								<option value="">-Choose Type-</option>
									<option value="< 3 months"<?php echo ($this->Session->read('Application.ResidentSinceDate') == '< 3 months') ? ' selected="selected"' : ''; ?>>< 3 Months</option>
									<option value="3 to 6 months"<?php echo ($this->Session->read('Application.ResidentSinceDate') == '3 to 6 months') ? ' selected="selected"' : ''; ?>>3 to 6 Months</option>
									<option value="1-2 years"<?php echo ($this->Session->read('Application.ResidentSinceDate') == '1-2 years') ? ' selected="selected"' : ''; ?>>1-2 Years</option>
									<option value="2-3 years"<?php echo ($this->Session->read('Application.ResidentSinceDate') == '2-3 years') ? ' selected="selected"' : ''; ?>>2-3 Years</option>
									<option value="3-5 years"<?php echo ($this->Session->read('Application.ResidentSinceDate') == '3-5 years') ? ' selected="selected"' : ''; ?>>3-5 Years</option>
									<option value="more than 5 years"<?php echo ($this->Session->read('Application.ResidentSinceDate') == 'more than 5 years') ? ' selected="selected"' : ''; ?>>More than 5 Years</option>		
								</select>
	                        </div>
	                    	<div class="col-sm-4">
	                    ...
	                    <div class="row">
	                    	<div class="col-sm-4">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control"	name="CoMonthlyNetIncome" id="CoMonthlyNetIncome" value="<?php echo $this->Session->read('Application.CoMonthlyNetIncome'); ?>" data-parsley-required="true"  maxlength="5" tabindex="10"  
									data-parsley-required="true" 
									data-parsley-type="digits" 
									data-parsley-length="[1,5]"
									data-parsley-group="step6"/>
  ...
  <div class="modal-content">
   <!-- <span class="close">&times;</span>-->
    <p>
		...
		<label for="LoanAmount">First Loan Amount</label>
    	<select name="LoanAmount" class="form-control" id="LoanAmount1" tabindex="1" 
			data-parsley-required="true" 
			data-parsley-group="step1">
			<option value="">-Choose Amount-</option>
			<?php 
		...
		<label for="LoanAmount">Second Loan Amount</label>
    	<select name="LoanAmount" class="form-control" id="LoanAmount2" tabindex="1" 
			data-parsley-required="true" 
			data-parsley-group="step1">
			<option value="">-Choose Amount-</option>
			<?php 
		...
		<li class="pull-right next"><button tabindex="20" id="buyer_save" type="button" class="btn-lg btn-warning btnnext">Next <span class="glyphicon glyphicon-chevron-right"></span></button></li>			
    </p>
  </div>
