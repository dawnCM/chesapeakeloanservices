...
//Page 2 - Application :: start
	...
	$( "#buyer_save" ).click(function() {
		saveSingleSession('LoanAmount1',jQuery('#LoanAmount1').val());
		saveSingleSession('LoanAmount2',jQuery('#LoanAmount2').val());
		...
		jQuery.ajax({
			...
			headers:{
				...
				if(str == 'success'){
					...
					var step = xhr.responseJSON.step;
					if(status == 'No Buyer' && step == 2){
